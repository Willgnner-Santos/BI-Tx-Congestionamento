...
# ALTERAÇÃO: O padrão agora é 'bi_tx_congestionamento' em vez de 'public'
DB_SCHEMA = os.getenv("DB_SCHEMA", "bi_tx_congestionamento")
...
def main() -> None:
    ...
    try:
        ...
        # =========================================================
        # NOVO PASSO: Garantir que o schema existe no banco
        # =========================================================
        print(f"\nVerificando/Criando esquema (schema): '{DB_SCHEMA}'...")
        with engine.begin() as conn:
            conn.execute(text(f"CREATE SCHEMA IF NOT EXISTS {DB_SCHEMA};"))
        print(f"Esquema '{DB_SCHEMA}' pronto para uso.")
